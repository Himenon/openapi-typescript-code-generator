...
export class Client<RequestOption> {
    ...
    public async getPodProxyWithPath(params: Params$getPodProxyWithPath, option?: RequestOption): Promise<Response$getPodProxyWithPath$Status$200["application/json"]> {
        const url = this.baseUrl + `/pods/${encodeURIComponent(params.parameter.name)}/proxy/${encodeURIComponent(params.parameter.path)}`;
        const headers = {
            Accept: "application/json"
        };
        const queryParameters: QueryParameters = {
