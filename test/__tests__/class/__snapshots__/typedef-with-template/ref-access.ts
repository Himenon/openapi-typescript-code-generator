...
export class Client<RequestOption> {
    ...
    public async getBook(params: Params$getBook, option?: RequestOption): Promise<Response$getBook$Status$200["application/json"]> {
        const url = this.baseUrl + `/get/book/${encodeURIComponent(params.parameter.id)}`;
        const headers = {
    ...
    public async getDescription(params: Params$getDescription, option?: RequestOption): Promise<Response$getDescription$Status$200["application/json"]> {
        const url = this.baseUrl + `/get/book/${encodeURIComponent(params.parameter.id)}/description`;
        const headers = {
            Accept: "application/json"
        };
        return this.apiClient.request({
    ...
    public async getAuthor(params: Params$getAuthor, option?: RequestOption): Promise<Response$getAuthor$Status$200["application/json"]> {
        const url = this.baseUrl + `/get/author/${encodeURIComponent(params.parameter.id)}`;
        const headers = {
            Accept: "application/json"
        };
        return this.apiClient.request({
    ...
    public async getPublisher(params: Params$getPublisher, option?: RequestOption): Promise<Response$getPublisher$Status$200["application/json"]> {
        const url = this.baseUrl + `/get/publisher/${encodeURIComponent(params.parameter.id)}`;
        const headers = {
            Accept: "application/json"
        };
        return this.apiClient.request({
    ...
    public async createPublisher(params: Params$createPublisher, option?: RequestOption): Promise<Response$createPublisher$Status$200["application/json"]> {
        const url = this.baseUrl + `/create/publisher/{id}`;
        const headers = {
    ...
    public async createPublisherV2<RequestContentType extends RequestContentType$createPublisherV2>(params: Params$createPublisherV2<RequestContentType>, option?: RequestOption): Promise<Response$createPublisherV2$Status$200["application/json"]> {
    ...
    public async getBookById(params: Params$getBookById, option?: RequestOption): Promise<Response$getBookById$Status$200["application/json"]> {
        const url = this.baseUrl + `/author/author-${encodeURIComponent(params.parameter.authorId)}.a.${encodeURIComponent(params.parameter.bookId)}.b/book/${encodeURIComponent(params.parameter.bookId)}.json`;
        const headers = {
            Accept: "application/json"
        };
        return this.apiClient.request({
