...
import { CodeGenerator, type Option as CodeGeneratorOption } from "../../dist/index.js";
import * as Templates from "../../dist/templates.js";
import type * as Types from "../../dist/types.js";
...
export const generateTemplateCodeOnly = (
  ...
  isValidate: boolean,
  option: Templates.CurryingFunctionalApiClient.Option,
): void => {
  const codeGenerator = new CodeGenerator(inputFilename);
  if (isValidate) {
    codeGenerator.validateOpenApiSchema({
  ...
  const apiClientGeneratorTemplate: Types.CodeGenerator.CustomGenerator<Templates.CurryingFunctionalApiClient.Option> = {
