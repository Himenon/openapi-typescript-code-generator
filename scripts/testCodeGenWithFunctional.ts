...
const main = () => {
  ...
  Writer.generateTemplateCodeOnly("test/api.test.domain/index.yml", "test/code/functional/template-only/api.test.domain.ts", true, { sync: false });
  Writer.generateTemplateCodeOnly("test/api.test.domain/index.yml", "test/code/functional/template-only/sync-api.test.domain.ts", true, { sync: true });
  ...
  Writer.generateTypedefWithTemplateCode("test/api.test.domain/index.yml", "test/code/functional/typedef-with-template/api.test.domain.ts", true, {
    sync: false,
  });
  Writer.generateTypedefWithTemplateCode("test/api.test.domain/index.yml", "test/code/functional/typedef-with-template/sync-api.test.domain.ts", true, {
    sync: true,
  });
  ...
  Writer.generateTypedefWithTemplateCode("test/remote.ref.access/v1.yml", "test/code/functional/typedef-with-template/remote-ref-access.ts", false, {
    sync: false,
  });
  ...
  Writer.generateTypedefWithTemplateCode("test/unknown.schema.domain/index.yml", "test/code/functional/unknown.schema.domain/client.ts", false, {
    sync: false,
  });
